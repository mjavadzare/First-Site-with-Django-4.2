from BrandNewSite.settings import *
...
ALLOWED_HOSTS = ['themikey.ir','www.themikey.ir']
#INSTALLED_APPS = []
...
DATABASES = {
    'default': {
        ...
        'NAME': 'themikey_mikey',
        'USER': 'themikey_javad',
        'PASSWORD': 'zX2Yj(8*u!x3',
        'HOST': 'localhost',
        'PORT': '3306',
    }
}

STATIC_ROOT = '/home/themikey/public_html/static'
MEDIA_ROOT = '/home/themikey/public_html/media' 

# from BrandNewSite.settings import LOGIN_URL , LOGIN_REDIRECT_URL
